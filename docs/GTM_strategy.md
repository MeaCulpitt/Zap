...
* **Use Case:** "One-Click Demos" embedded in web store-pages, bypassing the need for multi-gigabyte downloads.
...
* **Hardware Bounties:** Direct Alpha-token rewards for miners maintaining 99.9% uptime on RTX 4080+ hardware during the first 180 days.

### Validator Incentives: The "Integrity Dividend"
* **Discovery Rewards:** Validators earn increased dividends for successfully auditing and onboarding miners in underserved geographic territories.

### User Incentives: The "Proof of Play" Airdrop
* **Subsidized Streaming:** Free high-fidelity streaming for all users during the Phase 1 "Coverage" period.
* **Telemetry Rewards:** Users earn "Alpha" tokens for submitting encrypted lag-reports and performance data, helping refine the subnet's scoring algorithms.
